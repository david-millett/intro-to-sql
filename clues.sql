...
-- SELECT name, code FROM countries WHERE population = 1000;
...
SELECT name, language, percentage FROM countrylanguages JOIN countries ON countrylanguages.countrycode = countries.code WHERE language = 'Italian' AND percentage = 100;
-- San Marino
...
SELECT cities.name, countries.name FROM cities JOIN countries ON countries.code = cities.countrycode WHERE cities.name LIKE 'Serra%' AND countries.continent = 'South America';
-- Brazil
